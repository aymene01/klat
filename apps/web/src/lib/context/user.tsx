...
import { User as OriginalUser } from '@klat/graphql'
import { isEmpty, omit } from 'lodash'
import { useRouter } from 'next/router'
import { useAsync } from '@klat/hooks'
...
export const useUser = () => {
  ...
  const login = (payload: Payload, token: string) => {
    const { username, uuid } = payload.user
    dispatch({ type: 'LOGIN', payload: { uuid, username }, token })
  }
